...
public class UIModelRotator : MonoBehaviour
{
    ...
    [SerializeField] private UIModelAnim modelAnim;
    ...
    // [properties]
    public UIModelAnim ModelAnim { get => modelAnim; }
    ...
    public void LoadModel(string key)
    {
        ...
        var model = ConfigManager.Instance.GetModelByKey(key);
        var prefab = Instantiate(model, tranModel);
        modelAnim = prefab.GetComponent<UIModelAnim>();
